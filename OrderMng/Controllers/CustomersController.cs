...
namespace OrderMng.Controllers
{
    public class CustomersController : Controller
    {
        ...
        public CustomersController(ModelDbContext context)
        {
            _context = context;
        }
        ...
        // GET: Customers/EditByUser/5
        public async Task<IActionResult> EditByUser(string id)
        {
            if (id == null)
            {
                return NotFound();
            ...
            if (customer == null)
            {
                return RedirectToAction("Create", "Customers", new { Id = id });
            }
            else
            {
                return RedirectToAction("Create", "Edit", new { Id = customer.CustomerId });
            }
